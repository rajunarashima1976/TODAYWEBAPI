...
using CBA.Training.Talmate.Api.UserService;
...
using CBA.Training.Talmate.Api;
using AutoMapper;
using CBA.Training.Talmate.Api.DemandService;
using System.Collections.Generic;
using CBA.Training.Talmate.Api.Filter;
using CBA.Training.Talmate.Api.ExceptionHandling;
using CBA.Training.Talmate.Api.LoggerService;
using CBA.Training.Talmate.Api.RecommendationService;
...
namespace CBA.Training.Talmate.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ILoggerService, LoggerService.LoggerService>();
